...
def run(
    ...
    (
        ...
        .add_constraint_module(constraints.PartTimeAssignmentConstraint, penalty_per_unit=1)
        .add_constraint_module(constraints.MorningShiftConstraint, penalty_per_unit=99)
        .add_constraint_module(constraints.AfternoonShiftConstraint, penalty_per_unit=99)
        ...
        .add_constraint_module(constraints.SpecialWorkingShiftConstraint, penalty_per_unit=5)
        ...
        .add_constraint_module(constraints.ConsecutiveNightShiftsConstraint)
